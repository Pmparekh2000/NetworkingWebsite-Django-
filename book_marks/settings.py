"""
Django settings for book_marks project.
...
SECRET_KEY = 'l(=k^!vd)4t1#go*es@3i@t3tqpr$t1x=w!he%+uz=)lnqg1q9'
...
WSGI_APPLICATION = 'book_marks.wsgi.application'
...
# The above url is triggered once login is successfull
LOGIN_URL = 'login'
LOGOUT_URL = 'logout'
